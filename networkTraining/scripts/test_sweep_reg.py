...
def test_procedure(net, test_records):
    ...
    # Network forward
    logit_face, logit_curve, _ = net.load_sweep_reg_net(userStroke_input,
                                                        cnormal_input,
                                                        cdepth_input,
                                                        hyper_params['rootFt'],
                                                        is_training=False)
    ...
    return test_loss, test_fh_loss, test_real_fh_loss, test_line_loss, test_real_line_loss, test_gt_face, \
           test_pred_face, test_gt_line, test_pred_curve, test_userStroke, stroke_mask, \
